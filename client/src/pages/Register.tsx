    ...
    <div className="flex min-h-screen bg-zinc-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 bg-gradient-to-br from-zinc-950 via-zinc-900 to-indigo-950 border-r border-zinc-800">
        ...
        <div className="space-y-5">
          <h2 className="text-3xl font-light leading-tight text-zinc-200">
      ...
      <div className="flex w-full items-start justify-center overflow-y-auto px-6 py-12 lg:w-1/2">
        <div className="w-full max-w-sm space-y-7">
          ...
          <div>
            ...
            <p className="mt-1.5 text-sm text-zinc-500">Get started — it only takes a minute.</p>
          </div>
                  ...
                  <ul className="mt-2.5 space-y-1">
                    {passwordChecks.map(({ label, pass }) => (
                      <li key={label} className="flex items-center gap-1.5 text-xs">
                        ...
                        />
                        <span className={pass ? 'text-zinc-400' : 'text-zinc-600'}>{label}</span>
                      </li>
                    ))}
                  </ul>
                )}
